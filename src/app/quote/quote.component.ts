...
export class QuoteComponent implements OnInit {
  quotes: Quote[] = [
    ...
    {
      statement: `There is no collective slavery revenge fantasy among black people, but I am certain, if there were one, it would not be about white people, not at all. My slavery revenge fantasy would probably involve being able to read and write without fear of punishment or persecution coupled with a long vacation in Paris. It would involve the reclamation of dignity on my own terms and not with the 'generous' assistance of benevolent white people who were equally complicit in the ills of slavery.`,
      author: 'Roxane Gay',
    },
    {
      statement:
